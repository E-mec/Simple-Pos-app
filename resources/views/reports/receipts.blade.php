<div id="invoice-POS">
    ...
    <div class="mid">
        <div class="info">
            ...
            <p>
                Address : Back of Chem igbogo road, choba
                Email : ekebuisichinwendu@yahoo.com
                Phone : 08104133974
            </p>
        </div>
    </div>
    ...
    <div class="bot">
        <div id="table">
            <table>
                ...
                @foreach ($order_detail as $receipt )
                ...
                <tr class="tabletitle">
                    ...
                    <td class="Payment">
                        <h2>
                            {{ number_format($order_detail->sum('amount'), 2) }}
                        </h2>
                    </td>
                </tr>
            </table>
            ...
            <div class="legalcopy">
                <p class="legal"> <strong>** Thanks for shopping with us **</strong><br>
                    The goods which are subject to tax, prices include tax
                </p>
            </div>
